...
interface PrismTransformerInterface
{
     ...
     *
     * @return TransformerResult|PendingDispatch|null The transformation result containing the
     *                                                 processed content for sync execution, or a
     *                                                 PendingDispatch for async execution.
